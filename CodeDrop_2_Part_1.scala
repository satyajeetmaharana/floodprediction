...
//val df_joined_noaa = df_as_noaa.join(df_as_noaa_geo, df_as_noaa_geo("Station") <=> df_as_noaa("STATION"),"inner")

val df_joined_noaa = df_as_noaa.join(df_as_noaa_geo, Seq("Station"))


//df_joined_noaa.registerTempTable("noaa_joined")
...
hdfs dfs -getmerge /user/sm8235/final_code/FloodPrediction_7pm.csv floodPrediction_dataset_7pm.csv


python csv2libsvm.py --skip-headers floodPrediction_dataset_7pm.csv floodPrediction_dataset_7pm_libsvm.txt


hdfs dfs -put floodPrediction_dataset_7pm_libsvm.txt /user/sm8235/final_code/floodPrediction_dataset_7pm_libsvm.txt
...
hdfs dfs -getmerge /user/sm8235/final_code/DATA_FOR_TABLEAU.csv DATA_FOR_TABLEAU.csv

hdfs dfs -getmerge /user/sm8235/final_code/DATA_FOR_LIB.csv DATA_FOR_LIB.csv


python csv2libsvm.py --skip-headers DATA_FOR_LIB.csv DATA_TEST_LIBSVM.txt



hdfs dfs -put DATA_TEST_LIBSVM.txt /user/sm8235/final_code/DATA_TEST_LIBSVM.txt
